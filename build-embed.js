...
const js =
  ...
  fs.readFileSync(path.join(root, "js", "content-extended.js"), "utf8") +
...
html = html.replace(
  /  <script src="data\/locations\.js"><\/script>\s*<script src="js\/i18n\.js"><\/script>\s*<script src="js\/content-extended\.js"><\/script>\s*<script src="js\/app\.js"><\/script>/,
  `  <script>\n${js}\n  </script>`
);
